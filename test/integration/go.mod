...
module gitee.com/zhaochuninhefei/fabric-sdk-go-gm/test/integration

go 1.17

require (
	gitee.com/zhaochuninhefei/fabric-config-gm v0.0.2
	gitee.com/zhaochuninhefei/fabric-sdk-go-gm v0.0.0
...
replace (
	gitee.com/zhaochuninhefei/fabric-sdk-go-gm => ../../
