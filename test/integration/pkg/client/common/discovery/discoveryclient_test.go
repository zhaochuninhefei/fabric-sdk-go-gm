...
func testEndorsers(t *testing.T, sdk *fabsdk.FabricSDK, interest *protosdiscovery.ChaincodeInterest, filter discclient.Filter, expectedEndorserGroups ...[]string) {
...
func sendEndorserQuery(t *testing.T, ctx contextAPI.Client, client discovery.Client, interest *protosdiscovery.ChaincodeInterest, peerConfig fab.PeerConfig) (discclient.ChannelResponse, error) {
...
func newCCCall(ccID string, collections ...string) *protosdiscovery.ChaincodeCall {
	return &protosdiscovery.ChaincodeCall{
		Name:            ccID,
		CollectionNames: collections,
	}
}

func newInterest(ccCalls ...*protosdiscovery.ChaincodeCall) *protosdiscovery.ChaincodeInterest {
	return &protosdiscovery.ChaincodeInterest{Chaincodes: ccCalls}
}
