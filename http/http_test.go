...
func TestCmdGoNoHTTPServer(t *testing.T) {
	...
	wantSym := map[string]bool{
		...
		"gitee.com/zhaochuninhefei/gmgo/gmhttp.(*Client).Get":          true,
...
func TestOmitHTTP2(t *testing.T) {
	...
	out, err := exec.Command(goTool, "test", "-short", "-tags=nethttpomithttp2", http "gitee.com/zhaochuninhefei/gmgo/gmhttp").CombinedOutput()
	if err != nil {
...
func TestOmitHTTP2Vet(t *testing.T) {
	t.Parallel()
	goTool := testenv.GoToolPath(t)
	out, err := exec.Command(goTool, "vet", "-tags=nethttpomithttp2", http "gitee.com/zhaochuninhefei/gmgo/gmhttp").CombinedOutput()
	if err != nil {
