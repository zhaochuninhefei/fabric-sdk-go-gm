...
import (
	...
	"gitee.com/zhaochuninhefei/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric-ca/lib/client/credential"
	x509cred "gitee.com/zhaochuninhefei/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric-ca/lib/client/credential/x509"
	"gitee.com/zhaochuninhefei/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric-ca/lib/streamer"
	"gitee.com/zhaochuninhefei/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric-ca/lib/tls"
	...
	cspsigner "gitee.com/zhaochuninhefei/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/bccsp/signer"
...
func (c *Client) GenCSRUsingKey(req *api.CSRInfo, id string, k core.Key) ([]byte, core.Key, error) {
...
func (c *Client) generateCSPSigner(cr *csr.CertificateRequest, key core.Key) (crypto.Signer, core.Key, error) {
	if key == nil {
		// generate new key
		key, cspSigner, err := util.BCCSPKeyRequestGenerate(cr, c.csp)
		if err != nil {
