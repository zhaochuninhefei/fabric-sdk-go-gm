...
import (
	...
	"gitee.com/zhaochuninhefei/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/bccsp/gm"
...
func ImportBCCSPKeyFromPEMBytes(keyBuff []byte, myCSP core.CryptoSuite, temporary bool) (core.Key, error) {
	...
	key, err := gx509.ReadPrivateKeyFromMem(keyBuff, nil)
	if err != nil {
		return nil, errors.WithMessage(err, fmt.Sprintf("Failed parsing private key from %s", keyFile))
	}

	priv, err := gx509.MarshalSm2UnecryptedPrivateKey(key)
	if err != nil {
